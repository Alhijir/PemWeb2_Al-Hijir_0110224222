      ...
      <form method="POST" action="proses_pasien.php">
        ...
        <div class="form-group">
          ...
          <select name="kelurahan_id" class="form-control" required>
            ...
            <option value="1" <?= $pasien['kelurahan_id'] == 1 ? 'selected' : '' ?>>Ciganjur</option>
            <option value="2" <?= $pasien['kelurahan_id'] == 2 ? 'selected' : '' ?>>Tanjung Barat​</option>
            <option value="3" <?= $pasien['kelurahan_id'] == 3 ? 'selected' : '' ?>>Lenteng Agung</option>
            <option value="4" <?= $pasien['kelurahan_id'] == 4 ? 'selected' : '' ?>>Srengseng Sawah</option>
          </select>
        </div>
